...
use backend\models\SignupConfirmForm;
use backend\models\PasswordResetRequestForm;
use backend\models\PasswordResetTokenVerificationForm;
...
class UserController extends ActiveController
{
    ...
    public function behaviors()
    {
        ...
        $behaviors['authenticator']['except'] = ['login', 'signup', 'confirm', 'password-reset-request', 'password-reset-token-verification', 'password-reset', 'options'];
        return $behaviors;
    }
